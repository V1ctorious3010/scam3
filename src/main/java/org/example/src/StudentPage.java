...
public class StudentPage extends JFrame {
	...
	public StudentPage() {
		...
		Image img2=new ImageIcon(this.getClass().getResource("/img/download.png")).getImage();
		...
		Image viewBooksImg=new ImageIcon(this.getClass().getResource("/img/viewBooks.png")).getImage().getScaledInstance(55, 55, Image.SCALE_DEFAULT);
		...
		Image viewNoticeImg=new ImageIcon(this.getClass().getResource("/img/notice.png")).getImage().getScaledInstance(55, 55, Image.SCALE_DEFAULT);
		...
		Image issueImg=new ImageIcon(this.getClass().getResource("/img/issue.png")).getImage();
		...
		Image viewStatic=new ImageIcon(this.getClass().getResource("/img/Statics.png")).getImage().getScaledInstance(60, 60, Image.SCALE_DEFAULT);
