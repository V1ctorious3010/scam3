...
public class Settings extends JFrame {
	...
	public Settings() {
		...
		Image clgLogo=new ImageIcon(this.getClass().getResource("/img/pass_change.png")).getImage().getScaledInstance(40, 40, Image.SCALE_DEFAULT);
		...
		Image accountChangeImg=new ImageIcon(this.getClass().getResource("/img/acc_change.png")).getImage().getScaledInstance(40, 40, Image.SCALE_DEFAULT);
		...
		Image deleteUserImg=new ImageIcon(this.getClass().getResource("/img/deleteUser.png")).getImage().getScaledInstance(40, 40, Image.SCALE_DEFAULT);
