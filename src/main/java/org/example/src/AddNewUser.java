...
public class AddNewUser extends JFrame {
	...
	public AddNewUser() {
		...
		Image img=new ImageIcon(this.getClass().getResource("/img/logo.jpg")).getImage();
		...
		Image saveIcon=new ImageIcon(this.getClass().getResource("/img/login.png")).getImage().getScaledInstance(13, 17, Image.SCALE_DEFAULT);
		...
		Image resetIcon=new ImageIcon(this.getClass().getResource("/img/resetIcon.png")).getImage().getScaledInstance(13, 17, Image.SCALE_DEFAULT);
